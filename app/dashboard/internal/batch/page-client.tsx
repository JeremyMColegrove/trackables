        ...
        <Card className="border-border/70 shadow-none">
          <CardHeader className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div className="space-y-1">
              ...
              <CardDescription>
                Internal cron-driven batch processes with DB-backed run history
          ...
          <CardContent className="grid gap-4 sm:grid-cols-3">
            <div className="rounded-2xl border border-border/70 bg-background/70 p-4">
              <p className="text-sm text-muted-foreground">Registered jobs</p>
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
          <Card className="border-border/70 shadow-none">
            <CardHeader>
              ...
              <CardDescription>
                Select a job to inspect history or trigger a run manually.
              </CardDescription>
            </CardHeader>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="pr-6 text-right">Enabled</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {jobs.map((job) => (
                ...
                <div className="grid gap-3 rounded-2xl border border-border/70 bg-background/60 p-4">
                  ...
                  <div className="grid gap-3 text-sm sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      <p className="mt-1 font-medium">
                        {(selectedJob.timeoutMs / 1000).toLocaleString()}s
                      </p>
                    </div>
                    <div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-3">
                  ...
                  (runsQuery.data?.length ?? 0) === 0 ? (
                    <div className="rounded-2xl border border-dashed border-border/70 p-6 text-sm text-muted-foreground">
                      No runs have been recorded for this job yet.
                    </div>
                  ) : null}
                  {runsQuery.isLoading ? (
