...
export function UsageDetailsDialog({
	...
	const prettyPayload = singleHit
		? formatPayloadJson(singleHit.payload)
		: null;
			...
			<SheetContent side="right" className="w-full gap-0 p-0 sm:max-w-xl">
				<SheetHeader className="gap-3 border-b px-6 py-5">
					<div className="flex flex-wrap items-center gap-2 pr-10">
						...
						<Badge variant="secondary">{usageEvent.totalHits} hits</Badge>
					</div>
					<SheetDescription>
						{usageEvent.apiKey
							? `${usageEvent.apiKey.name} (${usageEvent.apiKey.maskedKey})`
							: `${usageEvent.apiKeyCount} API keys in this group`}
					</SheetDescription>
