...
CREATE TYPE "public"."trackable_form_field_kind" AS ENUM('rating', 'checkboxes', 'notes');--> statement-breakpoint
CREATE TYPE "public"."trackable_form_status" AS ENUM('draft', 'published', 'archived');--> statement-breakpoint
CREATE TYPE "public"."trackable_item_status" AS ENUM('draft', 'active', 'archived');--> statement-breakpoint
...
CREATE TABLE "trackable_items" (
	...
	"slug" text NOT NULL,
	"description" text,
	"status" "trackable_item_status" DEFAULT 'draft' NOT NULL,
	"active_form_id" uuid,
...
CREATE INDEX "trackable_items_status_idx" ON "trackable_items" USING btree ("status");--> statement-breakpoint
